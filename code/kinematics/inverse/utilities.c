/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Tue Nov 24 20:13:35 2015 */
...
/* "kinematics/inverse/utilities.pyx":85
...
static PyObject *__pyx_pw_10kinematics_7inverse_9utilities_3point_line_distance_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("point_line_distance_fast (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_line_slope)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("point_line_distance_fast", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "point_line_distance_fast") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_point = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[0]); if (unlikely(!__pyx_v_point.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_line_slope = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_line_slope == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("point_line_distance_fast", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_10kinematics_7inverse_9utilities_2point_line_distance_fast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_point, __pyx_t_5numpy_float64_t __pyx_v_line_slope) {
  ...
  /* "kinematics/inverse/utilities.pyx":91
 *   Let b = 1
 *   """
 ...
 */
  __pyx_t_2 = 1;
  __pyx_v_y0 = (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_point.data + __pyx_t_2 * __pyx_v_point.strides[0]) )));
 ...
 */
  ...
  /* "kinematics/inverse/utilities.pyx":95
 *   cdef np.float64_t a = -1 * line_slope
 * 
 *   cdef np.float64_t distance = abs(a * x0 + y0) / sqrt(a * a + 1.0)             # <<<<<<<<<<<<<<
 *   return distance
 */
  ...
  /* "kinematics/inverse/utilities.pyx":96
 * 
 *   cdef np.float64_t distance = abs(a * x0 + y0) / sqrt(a * a + 1.0)
 *   return distance             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_distance); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *   Based on https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
 */
  __pyx_tuple__21 = PyTuple_Pack(6, __pyx_n_s_point, __pyx_n_s_line_slope, __pyx_n_s_x0, __pyx_n_s_y0, __pyx_n_s_a, __pyx_n_s_distance); if (unlikely(!__pyx_tuple__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_lsimons_workspace_deskbot, __pyx_n_s_point_line_distance_fast, 85, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *   Based on https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10kinematics_7inverse_9utilities_3point_line_distance_fast, NULL, __pyx_n_s_kinematics_inverse_utilities); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_point_line_distance_fast, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
